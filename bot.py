...
async def handle_buttons(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if query.data == "main_menu":
        ...
        await query.edit_message_text(
            "✍️ Напишите ваш вопрос одним сообщением.<br><br>"
            "По срочным вопросам связывайтесь напрямую с руководством лагеря или вожатыми отрядов.<br>"
            "<a href='https://drpolenovo.ru/informatsija-o-lagere/chasto-zadavaemye-voprosy.html'>Часто задаваемые вопросы.</a>",
        ...
        await query.edit_message_text(
            "🎙️Напишите ваш привет одним сообщением:<br>"
            "— Фамилия и имя ребенка<br>"
            "— Провинция<br>"
            "— Название музыкальной композиции с исполнителем. <i>(Музыка с пометкой \"Е\" не принимается)</i><br>"
            "— Текст привета.<br>",
            reply_markup=back_keyboard(),
            parse_mode="HTML"
        )
