...
async def handle_buttons(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if query.data == "main_menu":
        ...
        await query.edit_message_text(
            ...
            "По срочным вопросам связывайтесь напрямую с руководством лагеря или вожатыми отрядов.\n"
        ...
        await query.edit_message_text(
            "🎙️Напишите ваш привет одним сообщением:\n"
            "— Фамилия и имя ребенка\n"
            "— Провинция\n"
            "— Название музыкальной композиции с исполнителем <i>(музыка с пометкой \"Е\" не принимается)</i>\n"
            "— Текст привета",
            reply_markup=back_keyboard(),
            parse_mode="HTML"
        )
